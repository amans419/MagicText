...
export default function Footer() {
    ...
    const friends = [
        ...
        { name: "MagicBox.Tools - AI Tools Diresctory", href: "https://magicbox.tools", title: "MagicBox.Tools - AI Tools Directory " },
            ...
            <div className="container mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 max-w-7xl">
                <div className="col-span-2 md:col-span-3 lg:col-span-2">
                    ...
                    <p className="text-sm max-w-md">
                        Upload your images, customize the text placement, and share your creations instantly. Whether you're a design novice or pro, Text Magic helps you achieve stunning results effortlessly.                    </p>
                    <p className="text-sm mt-4">
                        Our intuitive platform lets you create professional-looking designs with just a few clicks.
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        {friends.map((item) => (
                            <li key={item.name}>
                                <Link href={item.href} title={item?.title} className="text-sm hover:text-white transition-colors">
                                    {item.name}
                                </Link>
                            </li>
                        ))}
