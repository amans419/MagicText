...
export const metadata: Metadata = {
  title:
    "TextLayr - Create Text Behind Image Effects Online | Free Design Tool",
  description:
  ...
  openGraph: {
    title: "TextLayr - Create Text Behind Image Effects Online",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "TextLayr - Text Behind Image Editor",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "TextLayr - Text Behind Image Editor",
